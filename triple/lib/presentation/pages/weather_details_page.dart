...
import 'package:weather_app_triple/presentation/widgets/details_weather.dart';
import 'package:weather_app_triple/presentation/widgets/weather_block.dart';
...
import '../triple/settings_state.dart';
...
class WeatherDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ScopedBuilder<SettingsStore, SettingsState>(
        store: getIt<SettingsStore>(),
        onState: (context, settingsState) {
          return Column(
