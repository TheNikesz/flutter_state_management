...
final weatherProvider =
    FutureProvider.autoDispose.family<List<Weather>, String>((ref, city) {
...
final settingsProvider = StateProvider<SettingsState>((ref) {
  return const SettingsState(
      isFahrenheit: false, isNight: false, isChart: false);
});

final sharedPrefenecesProvider =
    FutureProvider.autoDispose<SharedPreferencesState>((ref) async {
