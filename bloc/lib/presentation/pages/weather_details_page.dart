          ...
          return Column(
            ...
            children: [
              ...
              WeatherBlock(
                  ...
                  firstValue: UnitConverter.getHourLabel(weather.sunrise, settingsState.isFahrenheit),
                  secondLabel: 'Sunset',
                  isSecondIconWeather: true,
                  secondIcon: WeatherIcons.sunset,
                  secondValue: UnitConverter.getHourLabel(weather.sunset, settingsState.isFahrenheit),
                  isNight: isNight),
              WeatherBlock(
                  firstLabel: 'Rain sum',
                  isFirstIconWeather: true,
                  firstIcon: WeatherIcons.rain,
                  firstValue: UnitConverter.getPrecipitationLabel(weather.rainSum, settingsState.isFahrenheit),
                  secondLabel: 'Snowfall sum',
                  isSecondIconWeather: true,
                  secondIcon: WeatherIcons.snow,
                  secondValue: UnitConverter.getPrecipitationLabel(weather.snowfallSum, settingsState.isFahrenheit),
                  isNight: isNight),
              WeatherBlock(
                  firstLabel: 'Max wind speed',
                  isFirstIconWeather: true,
                  firstIcon: WeatherIcons.strong_wind,
                  firstValue: UnitConverter.getMaximumWindSpeedLabel(weather.windSpeed, settingsState.isFahrenheit),
